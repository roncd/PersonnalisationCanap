...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function toggleAccoudoirs() {
        const accoudoir1Select = document.getElementById("accoudoir_gauche");
        const accoudoir2Select = document.getElementById("accoudoir_droit");

        if (accoudoir1Select) accoudoir1Select.required = false;
        if (accoudoir2Select) accoudoir2Select.required = false;
    }
}
);    