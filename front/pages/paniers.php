...
$statut = isset($_GET['statut']) && in_array($_GET['statut'], ['validation', 'traitement', 'livraison', 'final'])
    ? $_GET['statut']
    : 'validation';
...
<head>
    ...
    <meta name="description" content="Retrouve ton suivis et historique de commande de produits vendu à l'unité." />
