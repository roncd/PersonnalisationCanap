  ...
  <script>
    ...
    labels.forEach(label => {
      label.addEventListener('click', e => {
        e.preventDefault(); // empêche le radio d’être coché
