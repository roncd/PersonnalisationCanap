...
try {
    ...
    $sql = "INSERT INTO commande_detail (prix, prix_dimensions, commentaire, statut, id_client, id_structure, longueurA, longueurB, longueurC, id_banquette, id_mousse, id_accoudoir_gauche, id_accoudoir_droit, id_dossier_bois, id_couleur_bois, id_motif_bois, id_couleur_tissu_bois, id_decoration, id_nb_accoudoir)
            SELECT prix, prix_dimensions, commentaire, statut, id_client, id_structure, longueurA, longueurB, longueurC, id_banquette, id_mousse, id_accoudoir_gauche, id_accoudoir_droit, id_dossier_bois, id_couleur_bois, id_motif_bois, id_couleur_tissu_bois, id_decoration, id_nb_accoudoir
