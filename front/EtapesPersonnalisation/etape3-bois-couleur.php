...
$stmt = $pdo->query("SELECT * FROM couleur_bois WHERE visible = 1 ORDER BY prix ASC");
...
<head>
  ...
  <meta name="description" content="Commence la personnalisation de ton canapé, choisis la couleur du bois de ton futur canapé marocain." />
