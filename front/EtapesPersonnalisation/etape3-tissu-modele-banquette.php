...
$stmt = $pdo->query("SELECT * FROM modele WHERE visible = 1 ORDER BY prix ASC");
...
<head>
  ...
  <meta name="description" content="Commence la personnalisation de ton canapé, choisis le modèle de ton futur canapé marocain." />
