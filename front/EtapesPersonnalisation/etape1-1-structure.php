...
$stmt = $pdo->query("SELECT * FROM structure WHERE visible = 1 ORDER BY prix ASC");
...
<head>
  ...
  <meta name="description" content="Commence la personnalisation de ton canapé, choisis la strucutre, configuration de ton futur canapé marocain." />
