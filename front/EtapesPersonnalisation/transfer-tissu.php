...
try {
    ...
    $sql = "INSERT INTO commande_detail (prix, commentaire, date, statut, id_client, id_structure, longueurA, longueurB, longueurC, id_banquette, id_mousse, id_accoudoir_tissu, id_dossier_tissu, id_couleur_tissu, id_motif_tissu, id_modele, id_nb_accoudoir)
            SELECT prix, commentaire, date, statut, id_client, id_structure, longueurA, longueurB, longueurC, id_banquette, id_mousse, id_accoudoir_tissu, id_dossier_tissu, id_couleur_tissu, id_motif_tissu, id_modele, id_nb_accoudoir
