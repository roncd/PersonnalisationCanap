...
$stmt = $pdo->query("SELECT * FROM type_banquette WHERE visible = 1");
...
<head>
  ...
  <meta name="description" content="Commence la personnalisation de ton canapé, choisis le type de banquette de ton futur canapé marocain." />
