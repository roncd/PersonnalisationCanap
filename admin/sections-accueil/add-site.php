...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($slug) || empty($titre)) {
        ...
        try {
            $stmt = $pdo->prepare("INSERT INTO sections_accueil (slug, titre, description, bouton_texte, bouton_lien, img, visible) VALUES (?, ?, ?, ?, ?, ?, ?)");
...
<head>
    ...
    <title>Ajoute une section - Accueil</title>
...
<body>
    ...
    <main>
        <div class="container">
            <h2>Ajoute une section - Accueil</h2>
