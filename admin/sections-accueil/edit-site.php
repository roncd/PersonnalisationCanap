...
$stmt = $pdo->prepare("SELECT * FROM sections_accueil WHERE id = :id");
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($slug) || empty($titre)) {
        ...
        try {
            $stmt = $pdo->prepare("UPDATE sections_accueil SET slug = ?, titre = ?, description = ?, bouton_texte = ?, bouton_lien = ?, img = ?, visible = ? WHERE id = ?");
...
<head>
    ...
    <title>Modifie une section - Accueil</title>
...
<body>
    ...
    <main>
        <div class="container">
            <h2>Modifie une section - Accueil</h2>
                ...
                <form class="formulaire-creation-compte" enctype="multipart/form-data" action="" method="POST">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <textarea id="description" name="description" class="input-field" required><?= htmlspecialchars($sections['description']) ?></textarea>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group">
