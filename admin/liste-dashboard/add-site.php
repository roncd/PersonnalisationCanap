...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($description) || empty($icon)) {
        ...
        try {
            $stmt = $pdo->prepare("INSERT INTO liste_dashboard (description, icon, visible) VALUES (?, ?, ?)");
            $stmt->execute([$description, $fileName, $visible]);
            $_SESSION['message'] = 'Contenu ajoutée avec succès.';
...
<head>
    ...
    <title>Ajoute du contenu de la liste - Dashboard</title>
...
<body>
    ...
    <main>
        <div class="container">
            <h2>Ajoute du contenu de la liste - Dashboard</h2>
