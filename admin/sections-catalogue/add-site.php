...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($slug) || empty($titre)) {
        ...
        try {
            $stmt = $pdo->prepare("INSERT INTO sections_catalogue (slug, titre, description, bouton_texte, bouton_lien, img, visible) VALUES (?, ?, ?, ?, ?, ?, ?)");
...
<head>
    ...
    <title>Ajoute une section - Catalogue</title>
...
<body>
    ...
    <main>
        <div class="container">
            <h2>Ajoute une section - Catalogue</h2>
