    ...
    if (empty($nom) || !isset($price)) {
        ...
        if (!isset($_SESSION['message'])) {
            try {
                ...
                $stmt = $pdo->prepare("UPDATE couleur_tissu SET nom = ?, prix = ?, img = ?, visible = ? WHERE id = ?");
                ...
                if ($stmt->rowCount() > 0) {
                    ...
                    if ($newImageUploaded) {
                        $uploadPath = $uploadDir . $fileName;
                        $ancienneImagePath = '../uploads/couleur-tissu-tissu/' . $ancienneImage;
                ...
                <form action="edit.php?id=<?php echo $couleurtissu['id']; ?>" method="POST" enctype="multipart/form-data" class="formulaire-creation-compte">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <img class="preview-img" src="../uploads/couleur-tissu-tissu/<?php echo htmlspecialchars($couleurtissu['img']); ?>" id="output" />
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group btn-slider">
                            ...
                            <label class="switch">
                                <input type="checkbox" id="visible" name="visible" <?php if ($couleurtissu['visible']) echo 'checked'; ?>>
